## You need to check backprop against analytics gradient calculation for a two layer (two nodes in the input, output, and hidden layers) take a single input [1,1]
